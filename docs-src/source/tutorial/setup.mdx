...
description: Installing dependencies and configuring your project.
---
...
Now from the root of your project, run `npm run start`. If everything worked out, you should now be able to point your browser to [http://localhost:4000/graphql](http://localhost:4000/graphql), and start interacting with your `GraphQL` server through `GraphQL Playground`. From playground, run the following query to verify that your server is behaving as expected:
